...
Minesweeper.prototype.click = function ( ev ) {
	...
	if ( $target.hasClass( "clickable" ) ) {
		$.ajax( {
			...
			data    : JSON.stringify( {game: this.game, x: $x, y: $y, flag: false, maybe: false, visited: true, 'csrfmiddlewaretoken': this.token} ),
...
Minesweeper.prototype.complete = function ( arg ) {
	...
	$parent.append( "<p class=\"pad-top options new\"><a class=\"btn btn-lg btn-success\" href=\"/new/\" role=\"button\"><i class=\"fa fa-rocket\"></i> New Game</a></p>" );
